...
public class Day10Manager : MonoBehaviour
{
    ...
    [SerializeField] private string nextSceneName = "Day 11";
    ...
    private void OnEndingDialogueFinished()
    {
        if (endOfDayReportUI != null)
        {
            endOfDayReportUI.SetSpecialMessage(
                "Alex is still behind her goal, but today helped her move in the right direction. Careful choices still matter."
            );
        }
