...
public class Day7Manager : MonoBehaviour
{
    ...
    [Header("Yellow Tint Effect")]
    [SerializeField] private CanvasGroup yellowTintOverlay;
    [SerializeField] private float yellowTintFadeDuration = 0.8f;
    [SerializeField] private float yellowTintAlpha = 0.35f;
    ...
    [SerializeField] private string nextSceneName = "Day 8";
    ...
    private void Awake()
    {
        ...
        {
            yellowTintOverlay.alpha = 0f;
            yellowTintOverlay.gameObject.SetActive(false);
        }
    ...
    public void CloseFromSystemScreen()
    {
        ...
        Debug.Log("[Day7] CloseFromSystemScreen called. Proceeding to final dialogue.", this);
    ...
    private void StartFinalDialogue()
    {
        ...
        if (yellowTintOverlay != null)
        {
            yellowTintOverlay.gameObject.SetActive(true);
            yellowTintOverlay.alpha = 0f;
            yellowTintOverlay.DOFade(yellowTintAlpha, yellowTintFadeDuration).SetEase(Ease.OutCubic);
        }
    ...
    private void ShowEOD()
    {
        ...
        if (yellowTintOverlay != null)
        {
            yellowTintOverlay.DOFade(0f, 0.3f).OnComplete(() =>
            {
                yellowTintOverlay.gameObject.SetActive(false);
            });
        }
